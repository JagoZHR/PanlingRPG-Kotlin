...
enum class BuffType(
    ...
    // === 负面状态 (杀伐) ===
    WEAKNESS("致盲虚弱", "§b", 0.8, BasicKeys.ATTR_PHYSICAL_DAMAGE),
    ARMOR_BREAK("融甲", "§c", 0.8, BasicKeys.ATTR_DEFENSE),
    ...
    // === 正面状态 (生息) ===
    // 金：双抗提升 (10% 或 动态数值)
    DEFENSE_UP("金石之护", "§e", 1.1, BasicKeys.ATTR_DEFENSE),

    // 火：攻击/法强提升 (15%)
    ATTACK_UP("烈焰之力", "§c", 1.15, BasicKeys.ATTR_PHYSICAL_DAMAGE),
